...
public Card(String name, String desc, int attack, int defense, int level, Attribute attribute_id, Race race_id, Archetype archetype_id, FrameType frame_type_id, Card_Type card_type_id, Card_image image_id ) {
	this.name = name;
	this.desc = desc;
	this.attack = attack;
